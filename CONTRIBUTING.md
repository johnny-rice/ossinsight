...
Please create a folder under [`apps/docs/content/blog/`]( https://github.com/pingcap/ossinsight/tree/main/apps/docs/content/blog), and create a `.md` file under the folder.
